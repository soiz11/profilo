...
//   return (
//     <>
//       {/* Placeholder div shown only if special is true or image is not yet loaded */}
//       {special && !imageLoaded ? (
//         <div
//           className={`absolute left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2 font-semibold text-[200px]`}
//         >
//           {"</>"}
//         </div>
//       ) : (
...
//       {/* Image should always be rendered to ensure onLoad gets triggered */}
//     </>
//   );
// };
