  ...
  return (
    <>
      ...
      {creations.map((creation, index) => (
        <div
          key={index}
          className="flex flex-col h-[fit-content]  bg-[#ededed] border-4 shadow-lg rounded-lg border-[white] w-[80vw] overflow-hidden pb-2 mb-9 "
        >
          ...
          <div className="flex mt-2 p-[16px]">
            <div className="flex flex-col px-[10px] w-[100%]">
              ...
              <div className="text-[8px] xxs:text-[10px] pb-3 xs:text-[12px] md:text-[14px] xl:text-[16px] text-[#5a5f61] flex pt-[30px]">
