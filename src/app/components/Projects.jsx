       ...
       <div className="w-[80vw]">
        ...
        { myprojects.map((myproject,index)=>(
            ...
            <div className=' h-[200px] xs:h-[250px]  w-[100%] relative rounded flex md:h-[0] md:group-hover:h-[300px] xl:group-hover:h-[350px] duration-1000 '>
                <div  onClick={() => handleButtonClick(myproject)} className=' rounded absolute bottom-2 opacity-0 group-hover:opacity-100 group-hover:bottom-6 duration-1000  right-6 md:right-10 px-8 py-2 bg-[black] text-[white] border-[3px] text-[18px] border-[white] cursor-pointer' >Dive to the Github</div>
                ...
                <div className='flex mt-2'>
                    <div className='hidden md:w-[450px] md:flex md:px-2 md:group-hover:w-[0] duration-1000'>
                    ...
                    <div className='flex flex-col px-[10px]'>
                        ...
                        <div className='text-[10px] pb-3 xs:text-[12px] md:text-[16px] xl:text-[18px] text-[#5a5f61]'>{myproject.description}</div>
                    </div>
                </div>
            </div> 
        ))
