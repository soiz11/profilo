...
const NewNamecard = () => {
  return (
    <div className="flex flex-col midwidth:mt-0 mt-[130px]">
      <div className="midwidth:flex hidden">
        <OnlyName />
      </div>

      <div className=" text-[8px] xxs:text-[10px] sm:text-[14px] xl:text-[16px] flex mt-3  mb-3 xl:mb-5  text-[#5a5f61] w-full">
